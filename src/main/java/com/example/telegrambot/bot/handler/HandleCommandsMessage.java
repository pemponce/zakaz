...
public class HandleCommandsMessage {
    ...
    public void sendHelpMessage(Long chatId) {
        sendMessageService.sendMessage(chatId, """
                ...
                Например если вы захотите изменить время(10:30 или 22:30) отправки какого либо вопроса, вы можете написать \n<code>/setTime question time</code>
                ...
                P.S. вопрос (как дела?) будет появляться у пользователей в 10:30 т.к. я написал (день), если напишешь (вечер) то в 22:30
                """);
    }
