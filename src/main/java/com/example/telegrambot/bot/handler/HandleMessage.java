...
public class HandleMessage {
    ...
    public void sendWelcomeMessage(Long chatId) {
        String welcomeText = """
                Привет! Добро пожаловать в нашего бота для удобного оповещения и опроса учебных групп.
                Пройдите авторизацию, для этого обратитесь к вашему куратору/старосте (или к главному админу @pemponceGTB) для получения 4х значного кода пожтверждения!
                Если вы не являетесь старостой/куртором группы то после прохождения авторизации вам остается ждать опросы и оповещения от ваших старост или кураторов.
                В случае если вы являетесь старостой/куртором то напишите /admin, после авторизации и связи с @pemponceGTB после можете ознакомится с командами бота (/help)""";
