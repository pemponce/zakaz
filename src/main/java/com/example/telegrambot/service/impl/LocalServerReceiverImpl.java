...
public final class LocalServerReceiverImpl implements VerificationCodeReceiver {
    ...
    public LocalServerReceiverImpl() {
        this(LOCALHOST, -1, CALLBACK_PATH, null, null);
    }

    LocalServerReceiverImpl(
    ...
    public static final class Builder {
        ...
        public LocalServerReceiverImpl build() {
            return new LocalServerReceiverImpl(
